...
class CpanelController extends BaseController {
    ...
    {
        return View::make(Config::get('backend::views.dashboard'));
    }
    ...
    public function getLogin()
    {
        ...
        return View::make(Config::get('backend::views.login'), compact('login_attribute'));
    }
    ...
    {
        $login_attribute = Config::get('cartalyst/sentry::users.login_attribute');
        return View::make(Config::get('backend::views.register'), compact('login_attribute'));
    }
    ...
    public function getLogout()
    {
        if (Sentry::check())
        {
            ...
            return Redirect::route('admin.login')->with('success', Lang::get('backend::users.logout'));
        }
    ...
    public function postLogin()
    {
        try
        {
            ...
            return Redirect::intended('admin')->with('success', Lang::get('backend::users.login_success'));
        }
    ...
    public function postRegister()
    {
        try
        {
            ...
            if( $validation->passes() )
            {
                ...
                return Redirect::route('admin.login')->with('success', Lang::get('backend::users.register_success'));
            }
